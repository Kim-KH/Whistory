...
const s = StyleSheet.create({
  ...
  badge: { fontSize: 14, fontWeight: '700', color: '#2f6b76', marginBottom: 8 },
  ...
  levelDesc: { fontSize: 14, color: '#d7ecdc', marginTop: 6 },
  ...
  mockBasic: { backgroundColor: '#1f4e57' },
  mockAdvanced: { backgroundColor: '#2f6b76' },
  mockTitle: { fontSize: 17, fontWeight: '800', color: '#fff8ee' },
  mockDesc: { fontSize: 13, color: '#fff8ee', marginTop: 6 },
